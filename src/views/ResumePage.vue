<template>
  <div class="text-center p-6" id="header">
    <p class="text-4xl p-3">Kyle Montville</p>
    <p class="text-2xl p-3 decoration-double overline">Full-Stack Web Developer</p>
  </div>

  <div class="text-justify p-8" id="description">
